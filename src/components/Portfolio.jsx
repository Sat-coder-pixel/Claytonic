...
import project1 from "../assets/homeimage.jpg";
import project2 from "../assets/homeimage.jpg";
import project3 from "../assets/homeimage.jpg";
import project4 from "../assets/homeimage.jpg";
...
const projects = [
  ...
  },
  {
    ...
    location: "Shimla",
    desc: "Cozy cottages with breathtaking mountain views.",
  },
];
      ...
      <div className="container mx-auto text-center px-6">
        ...
        >
          <motion.button
            ...
            className="px-10 py-4 bg-blue-600 text-white text-lg font-medium rounded-full shadow-lg hover:bg-blue-700 transition"
          >
